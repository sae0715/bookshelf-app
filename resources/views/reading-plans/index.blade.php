                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                    ...
                                    @else
                                    <form action="{{ route('reading-plans.uncomplete', $plan) }}" method="POST" class="inline" onsubmit="return confirm('読了を取り消しますか？');" novalidate>
                                        @csrf
                                        <button type="submit" class="text-gray-600 hover:text-gray-900">取り消す</button>
                                    </form>
                                    @endif
